...
router.post("/users/admin/register", authMiddleware_1.default, UserControllers_1.userControllers.register);
...
router.put("/users/admin/:id", authMiddleware_1.default, UserControllers_1.userControllers.updateUser);
